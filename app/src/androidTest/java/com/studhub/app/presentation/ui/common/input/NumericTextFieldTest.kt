...
import com.studhub.app.presentation.ui.NumericTextField
...
class NumericTextFieldTest {
    ...
    @Test
    fun componentNumericTextFieldGetsCreatedWithCorrectName() {
        composeTestRule.setContent {
            NumericTextField("This is my super name!")
        }
        composeTestRule.onNodeWithText("This is my super name!").assertExists()
    }

    @Test
    fun componentNumericTextFieldWritesUpdateTheField() {
        composeTestRule.setContent {
            NumericTextField("Test")
        }
    ...
    @Test
    fun componentNumericTextFieldUpdatesPassedRememberableCorrectly() {
        composeTestRule.setContent {
            rememberable = rememberSaveable { mutableStateOf("") }
            NumericTextField(label = "Test", rememberedValue = rememberable!!)
        }
        val field = composeTestRule.onNodeWithText("Test")
