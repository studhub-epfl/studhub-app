...
@Composable
fun ConversationButton(onClick: () -> Unit,  modifier: Modifier = Modifier) {
    ...
    Button(
        ...
        Text(text = stringResource(R.string.home_button_conversations), style = MaterialTheme.typography.titleMedium)
    }
}
